...
const categories = [
  {
    ...
    children: [
      ...
      { id: '수련생 등록 / 조회', icon: <DnsRoundedIcon />, url: '/students' },
      { id: '수업 과정 관리', icon: <PermMediaOutlinedIcon />, url: '/courses' },
      { id: '급/단증 발급 신청', icon: <SettingsIcon />, url: '/cert' },
    ],
  },
  {
    id: '관리',
    children: [
      { id: '사범 등록 / 조회', icon: <PeopleIcon />, url: '/instructors'},
      { id: '도장 정보', icon: <PublicIcon /> , url: '/' },
      { id: '협회', icon: <TimerIcon />, url: '/assosications' },
